...
namespace MultiViewMod
{
    ...
    public class MultiViewController : GameComponent
    {
        ...
        public MultiViewController(Game _)
        {
            Instance = this;
        ...
        public void CreateNewObservationWindow()
        {
            ...
            try
            {
                ...
                // 应用自动跟随设置
                if (MultiViewMod.Settings.AutoFollowSelected)
                {
