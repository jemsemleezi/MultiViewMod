    ...
    public class SecondaryCameraController
    {
        ...
        public void Initialize()
        {
            try
            {
                ...
                renderTexture = new RenderTexture(textureSize.x, textureSize.y, 16, RenderTextureFormat.ARGB32)
                {
                    antiAliasing = 1,
        ...
        private void CreateSecondaryCamera()
        {
            try
            {
                ...
                secondaryCamera.allowMSAA = false;
        ...
        private void UpdateViewport(Vector2 size)
        {
            try
            {
                    ...
                    size.x > 100 && size.y > 100)
                {
                    ...
                    renderTexture = new RenderTexture((int)size.x, (int)size.y, 16, RenderTextureFormat.ARGB32)
                    {
                        antiAliasing = 1,
                        filterMode = FilterMode.Point,
                        wrapMode = TextureWrapMode.Clamp
